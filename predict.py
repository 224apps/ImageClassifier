...
def arg_parser():
    ...
    parser.add_argument('--category_names',  type=str,  help='Mapping from categories to real names as str.')
...
#  loading our saved deep learning model from checkpoint
def load_checkpoint(checkpoint_path):
    ...
    # Freeze parameters and load the checkpoint
...
def main():
    ...
    # Load model trained with train.py, process the image and check the GPU
